...
pub use types::{
  is_bad_port, AddrV1, AddrV2, NIEntry, NIEntryCode, NIError, NIPurpose, NITrait, NetAddr, NetAddrError, NetInfo,
  NetInfoV1, NetInfoV2, NetworkType, ServiceV1, ServiceV2,
};
